...
prinCP=[]
try:
    prox= requests.get('https://github.com/SSC-LOL/BROTHER-12/blob/main/approval.%20txt').text
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/SSC.khan444?mibextid=b06tZ0')
logo =(f"""
\033[38;5;196m──────────────────────────────────────────────────
...
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mRX\033[1;91m-\033[1;92mSSC                     \033[1;91m|
...
def menu():
    ...
    if SSC in ['111']:
        ...
        os.system('xdg-open https://github.com/RX-SSC')
        os.system("python nono.py")
    elif SSC in ['3','03']:
        result()
    elif SSC in ['0']:
